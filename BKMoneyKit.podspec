#
#  Be sure to run `pod spec lint BKMoneyKit.podspec' to ensure this is a
...
#                    DESC
  ...
  s.source       = { :git => "https://github.com/bkook/BKMoneyKit.git", :tag => "0.0.5" }
  ...
  s.source_files  = "BKMoneyKit", "BKMoneyKit/BKMoneyKit/**/*.{h,m}"
  ...
  s.resource_bundle = { 'BKMoneyKit' => ['BKMoneyKit/BKMoneyKit/BKMoneyKit.bundle/*'] }
